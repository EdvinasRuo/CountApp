...
const StatsScreen = ({navigation, monthsExpenses, fixedExpenses, cachedFixedExpenses, budget, cachedBudget}) => {
    const allBudget = budget.concat(cachedBudget); 

        const sortedCosts = sortCosts(monthsExpenses, fixedExpenses, cachedFixedExpenses); 
