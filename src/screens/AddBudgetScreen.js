...
import validateNumbers from '../methods/validateNumbers';
...
const mapDispatchToProps =(dispatch) => {
    return {
        addToBudget: (name, sum) => {dispatch(addToBudget(name, sum))},
    };
}; 
...
export default connect (null, mapDispatchToProps)(AddBudgetScreen);
