...
const reducer = (state = initialState, action) => {
    switch(action.type) {
        case 'setFavoriteTypes': 
            return {...state, favoriteTypes: [...state.favoriteTypes, {
                name: action.value, 
        ...
        case 'addExpense': 
            return {...state, monthsExpenses: [...state.monthsExpenses, {
                name: action.name, 
                cost: action.cost, 
        ...
        case 'addFixedExpense': 
            return {...state, fixedExpenses: [...state.fixedExpenses, {
                name: action.name, 
                cost: action.cost, 
                month: moment().format('M'),
                year: moment().format('YYYY'),
        ...
        case 'deleteFixedExpense':   
            ...
            return {...state, fixedExpenses:filteredArray, cachedFixedExpenses: [...state.cachedFixedExpenses, cachedCost] }; 
        case 'deleteExpense':   
            //If months expense 
        ...
        case 'deleteFromBudget':   
            ...
            return {...state, budget:filteredBudgetArray, cachedBudget: [...state.cachedBudget, cachedBudgetItem] };     
...
export {setFavoriteTypes, setSearchTypes, addExpense, addFixedExpense, deleteFixedExpense, deleteFavoriteType, deleteExpense, addToBudget, deleteFromBudget} ; 