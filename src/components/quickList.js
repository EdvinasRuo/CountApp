...
import {setFavoriteTypes, setSearchTypes, addExpense, deleteFavoriteType} from '../redux/app-redux';
...
const mapDispatchToProps =(dispatch) => {
    return {
        ...
        deleteFavoriteType: (id) => {dispatch(deleteFavoriteType(id))},
    };
}; 
            ...
            <View>
                ...
                <FlatList 
                    ...
                    renderItem = {(item) => {
                        ...
                        <TouchableOpacity onPress={()=> deleteFavoriteType(item.item.id)}>
                        ...
                        <Button 
                            ...
                            title="Add"
                            onPress={() => {addExpense(item.item.name, cost[item.index])}}
                        />
                    </View> 
                    }}
                /> 
            </View>
            : <Text style={styles.smallInfo}>No favorites yet. Press plus sign and check favorte's check-box to add items here. </Text> }
        </Spacer>   
